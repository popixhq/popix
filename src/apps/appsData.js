...
export const apps = [
  {
    ...
    features: [
      ...
      { title: "Pin what matters", body: "Keep addresses, codes, and canned replies pinned to the top, always." },
      { title: "Private by design", body: "Everything stays on your device. No account, no cloud, no permissions — and passwords are never saved." },
    ],
    highlights: [
      { k: "1-tap", v: "re-copy anything" },
      { k: "0", v: "data leaves your phone" },
      { k: "None", v: "ads or permissions" },
    ],
    screens: [
      { label: "History", from: "#6E7FE6", to: "#B4BCEC" },
      { label: "Search", from: "#4E5FB5", to: "#9AA8E8" },
      { label: "Pinned", from: "#3A49A8", to: "#8EA0F0" },
    ],
    faqs: [
