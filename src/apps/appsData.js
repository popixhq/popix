...
export const apps = [
  ...
  },
  {
    slug: "offline-games",
    name: "Offline Games",
    tagline: "29 classic games in one offline app.",
    category: "Games",
    status: "coming-soon",
    playUrl: "",
    accent: "#6C4CF0",
    ...
    installs: "-",
    summary:
      "A pocket-sized arcade of 29 classic games, chess, sudoku, solitaire, ludo, 2048 and more, that all run fully offline, with one profile of coins and best scores that carries across every game.",
    features: [
      ...
      { title: "One profile, every game", body: "Coins, streaks, and best scores carry across all 29 games, not just one." },
      { title: "29 games, one small app", body: "A shared engine keeps the download tiny even with 29 games inside." },
    ...
    highlights: [
      { k: "29", v: "games in one app" },
      { k: "100%", v: "offline, no wifi" },
      { k: "1", v: "profile everywhere" },
    ],
    screens: [
      { label: "Game shelf", img: "/apps/offline-games/1-home.png" },
      { label: "Real chess", img: "/apps/offline-games/2-chess.png" },
      { label: "2048", img: "/apps/offline-games/3-2048.png" },
      { label: "Best scores", img: "/apps/offline-games/4-scores.png" },
      { label: "Settings", img: "/apps/offline-games/5-settings.png" },
      { label: "Solitaire", img: "/apps/offline-games/6-solitaire.png" },
      { label: "Word Search", img: "/apps/offline-games/7-wordsearch.png" },
      { label: "Bubble Shooter", img: "/apps/offline-games/8-bubbleshooter.png" },
    ],
    faqs: [
      { q: "Do I need an internet connection?", a: "No. All 29 games are fully playable offline, forever. Offline Games never needs wifi or data to play." },
      { q: "How many games are included?", a: "29 classic games, including Chess, Sudoku, Solitaire, Ludo, 2048, Ball Crusher, Word Search, Minesweeper, and more." },
    ...
    privacy: {
      ...
      intro:
        "Offline Games is an offline games app that keeps everything on your device. Here is exactly how it handles your data.",
      sections: [
        { h: "What the app stores", p: "Offline Games saves your game progress, best scores, coins, streak, favorite games, and settings in the app's private storage on your device only. This information never leaves your device and is not uploaded to us or anyone else. Clearing the app's data or uninstalling it removes everything." },
        { h: "Permissions and data collection", p: "Offline Games requests no special Android permissions and uses no internet connection to play. We collect, transmit, sell, and share no personal or usage data, and there are no accounts or sign-in." },
        ...
        { h: "Children", p: "Offline Games is safe for general audiences and collects no data from anyone, including children." },
        { h: "Contact", p: "Questions about this policy? Email contact@popixhq.com. If this policy changes, we will update the date above." },
      ],
    },
    terms: {
      updated: "14 July 2026",
      intro:
        "These terms cover your use of the Offline Games app. By downloading or using the app, you agree to them.",
      sections: [
        { h: "Using the app", p: "Offline Games is free to download and use for your own personal, non-commercial entertainment. Please don't resell, redistribute, decompile, or modify the app or its games, or try to disrupt how it works for others." },
        { h: "Coins, scores, and progress", p: "Coins, streaks, rewards, and scores in Offline Games are for in-game fun only. They have no real-world or monetary value, cannot be bought, sold, or exchanged for money, and may be reset if you clear the app's data or uninstall it." },
